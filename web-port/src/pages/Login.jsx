            ...
            <div className="w-full max-w-[420px] p-8 rounded-[20px] bg-[#11161d] border border-[#1f2633] shadow-2xl relative z-10">
                ...
                <div className="flex justify-center mb-6 relative">
                    ...
                    <div className="relative bg-[#0d4f9e00] p-4 rounded-2xl">
                        ...
                        <div className="w-16 h-16 bg-gradient-to-b from-[#1c2333] to-[#0d1117] rounded-xl flex items-center justify-center border border-[#2d3545] shadow-inner">
                            <ShieldCheck size={32} className="text-[var(--accent-color)]" />
                        </div>
                    </div>
                </div>
